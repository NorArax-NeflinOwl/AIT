...
{
    public class aitSimpleNoteModel : aitExtDataBaseModel, ICloneable, ISerializable
    {
        #region Properties
        ...
        public aitSimpleNoteModel() : base()
        {
            SetTabName(aitTabsNames.aitTBCalNote);
        }

        public aitSimpleNoteModel(
            string title, 
            string note, 
            DateTime? noteDate, 
        ...
        public aitSimpleNoteModel(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        ...
        {
            base.Clone();
            var newObj = new aitSimpleNoteModel(m_Title, m_Note, m_Date, m_DateTimeType, m_NoteType);
