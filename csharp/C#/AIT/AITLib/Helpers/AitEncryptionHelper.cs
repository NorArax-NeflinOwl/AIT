...
namespace AITLib.Helpers
{
    public class AitEncryptionHelper
    {
        ...
        private static byte[] m_Key = Encoding.ASCII.GetBytes("NorAraxNeflinOwl");
        ...
        public string Encrypt(string clearText, string password = null)
        {
            ...
            {
                Rfc2898DeriveBytes pdb = new Rfc2898DeriveBytes(!string.IsNullOrEmpty(password) ? password : m_EncryptionKey, m_Key);
