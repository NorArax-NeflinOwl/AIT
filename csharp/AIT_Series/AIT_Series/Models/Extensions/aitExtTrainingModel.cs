...
{
    public class aitExtTrainingModel : aitExtSimpleNoteModel, ICloneable, ISerializable
    {
        #region Properties
        ...
        public aitExtTrainingModel(SerializationInfo info, StreamingContext context) : base(info, context)
        {
