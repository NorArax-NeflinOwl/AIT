package com.arno.database;

import com.arno.managers.AitCrypter;
import com.arno.managers.AitLogger;
import com.arno.resources.AitLoggerPriority;
import com.arno.structures.AitClientData;
import com.arno.structures.AitMap;
...
public class AitLocalDB {
    ...
    private String dbFile = "\\arno.database\\arno.database";
    ...
    private void createDbDir() {
        String logDirPath = mainPath + "\\arno.database";
    ...
    private File createDbFile() throws Exception {
        ...
        if (!dbFile.exists()) {
            if(dbFile.createNewFile()) {
                AitLogger.getInstance().logToConsole(new Object[]{"Create arno.database file: " + timeStamp}, AitLoggerPriority.Information);
            }
        }
        else {
            AitLogger.getInstance().logToConsole(new Object[]{"Log arno.database exists: " + timeStamp}, AitLoggerPriority.Information);
        }
