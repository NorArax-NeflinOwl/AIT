...
public class AitClient {
    ...
    private void showCommand() {
        //TODO display in console list of command to use by arno.client to communicate with another arno.client or account managment
    }
}
