...
CREATE TABLE `identificators` (
  ...
  UNIQUE KEY `idn_value_UNIQUE` (`idn_value`)
...
INSERT INTO `identificators` VALUES (1,'test','2019-07-10 11:59:51'),(3,'ACK-AIT','2019-07-10 12:03:11');
...
INSERT INTO `settings` VALUES (1,'SQL_DEBUG_MODE',0,NULL),(2,'CR-AIT',5,'2019-07-10 11:44:25'),(3,'ISS-AIT',4,'2019-07-10 12:01:41'),(4,'ACK-AIT',0,NULL);
...
CREATE TABLE `usershosts` (
  ...
  `uhs_name` varchar(45) NOT NULL,
  `uhs_active` bit(1) DEFAULT b'0',
  `uhs_actuallogin` bit(1) DEFAULT b'0',
...
-- Dump completed on 2019-07-10 15:39:58
